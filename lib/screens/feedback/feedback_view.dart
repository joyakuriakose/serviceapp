                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: GridView.builder(
                                  shrinkWrap: true, // Ensures the GridView takes only the needed height
                                  physics: NeverScrollableScrollPhysics(), // Prevents scrolling inside the GridView
                                  gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                                    crossAxisCount: 2, // Number of columns
                                    crossAxisSpacing: 10.0, // Horizontal spacing between items
                                    mainAxisSpacing: 10.0, // Vertical spacing between items
                                    childAspectRatio: 9, // Adjust based on your desired width-to-height ratio
                                  ),
                                  itemCount: 4, // Total number of items
                                  itemBuilder: (context, index) {
                                    switch (index) {
                                      case 0:
                                        return buildOption(1, 1, "Very Satisfied");
                                      case 1:
                                        return buildOption(1, 2, "Satisfied");
                                      case 2:
                                        return buildOption(1, 3, "Dissatisfied");
                                      case 3:
                                        return buildOption(1, 4, "Very dissatisfied");
                                      default:
                                    ...
                                    child: Padding(
                                      ...
                                      child: Obx(
                                          ...
                                          decoration: InputDecoration(
                                            hintText: controller.isFeedbackEmpty.value ? "Write Your Feedback...." : null,
                                            hintStyle: TextStyle(
                                              color: Colors.grey,
                                              fontSize: 17,
                                              fontWeight: FontWeight.w400,
                                          ...
                                          maxLines: null,  // This allows the TextFormField to grow as needed
