...
class FeedbackView extends GetView<FeedbackController> {
  ...
  Widget buildOption(int question, int option, String text) {
    return Obx(() {
      ...
      switch (question) {
        case 1:
          isSelected = controller.selectedOption1.value == option;
          break;
        case 2:
          isSelected = controller.selectedOption2.value == option;
          break;
        case 3:
          isSelected = controller.selectedOption3.value == option;
          break;
      }
        ...
        body: Background(
          ...
          Column(
            children: [
              ...
              // Star rating and feedback text field
              SizedBox(height: Get.height * 0.02),
              Row(
                children: [
                  Container(
