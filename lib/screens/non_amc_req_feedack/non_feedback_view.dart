...
class NonFeedbackView extends GetView<NonFeedbackController> {
  const NonFeedbackView({Key? key}) : super(key: key);
  ...
  Widget buildOption(int question, int option, String text) {
    return Obx(() {
      ...
      final int? nonamcserviceId = Get.arguments['nonamcserviceId'] as int?;

      // Optionally use the nonamcserviceId to fetch data or display it
      print('Received Non-AMC Service ID: $nonamcserviceId');
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Obx(() => controller.isScreenProgress.value
                                        ...
                                        width: Get.width * 0.4,
                                        child: Text(
                                          nonamcserviceId != null
                                              ? nonamcserviceId.toString()
                                              : "No ID available",
                                          style: MyTheme.regularTextStyle(
                                            fontWeight: FontWeight.w700,
                                            fontSize: Get.height * 0.018,
