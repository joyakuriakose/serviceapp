...
abstract class NonFeedbackService {
  static Future<ApiResp> submitNonFeedback({
    required int customer_id,
    required int non_amc_service_id,
    String? answer_1,
    String? answer_2,
    String? answer_3,
    String? rating,
    ...
    try {
      ...
      await errMAsync(() async {
        resp = await MyDio().customPost(
          ApiPaths.nonamcservicereqfeedback,
          data: {
            'customer_id': customer_id,
            'amc_type': 1, // Set amc_type as 1 by default
            'non_amc_service_id': non_amc_service_id,
            'answer_1': answer_1,
            'answer_2': answer_2,
            'answer_3': answer_3,
            'rating': rating,
