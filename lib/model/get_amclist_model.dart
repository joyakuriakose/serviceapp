...
class GetAmcList {
  String? message;
  Map<String, String>? demandOption;
  ...
  factory GetAmcList.fromJson(Map<String, dynamic> json) => GetAmcList(
    ...
    demandOption: json["demand_option"] != null
        ? Map<String, String>.from(json["demand_option"])
        : null,
    amcList: json["amc_list"] != null
        ? List<AmcList>.from(json["amc_list"].map((x) => AmcList.fromJson(x)))
        : null,
  );

  Map<String, dynamic> toJson() => {
    "message": message,
    "demand_option": demandOption != null
        ? Map<String, dynamic>.from(demandOption!)
        : null,
    "amc_list": amcList != null
        ? List<dynamic>.from(amcList!.map((x) => x.toJson()))
        : null,
  };
...
// factory GetAmcList.fromJson(Map<String, dynamic> json) => GetAmcList(
//   message: json["message"],
//   demandOption: Map.from(json["demand_option"]).map((k, v) => MapEntry<String, String>(k, v)),
...
// Map<String, dynamic> toJson() => {
//   "message": message,
//   "demand_option": Map.from(demandOption).map((k, v) => MapEntry<String, dynamic>(k, v)),
